...
// Sample questions for testing (later will be fetched from Gemini API)
const sampleQuestions = [
  ...
  {
    id: 3,
    question: "In Formula 1, which driver holds the record for most world championships?",
...
export default function Quiz() {
  ...
  // Load quiz setup from localStorage
  useEffect(() => {
    if (mounted && typeof window !== 'undefined') {
      ...
      if (setupData) {
        ...
        setQuizSetup(parsed);
        // For now, use sample questions. Later we'll fetch from Gemini API
        setQuestions(sampleQuestions.slice(0, 10));
        setLoading(false);
      } else {
